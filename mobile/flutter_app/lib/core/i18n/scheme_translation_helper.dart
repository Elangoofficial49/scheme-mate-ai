class SchemeTranslationHelper {
  ...
  static String _translateBenefit(String text, String lang) {
    ...
    if (text.contains("15,000") &&
        text.contains("toolkit") &&
    ...
    // PM SVANidhi benefit
    if (text.contains("Working capital loan") ||
        text.contains("SVANidhi") ||
        (text.contains("10,000") && text.contains("tranche"))) {
      switch (lang) {
        case 'hi':
        case 'mr':
        case 'kok':
    ...
    // CGTMSE benefit
    if (text.contains("Collateral-free credit facility up to Rs. 5 Crore") ||
        text.contains("5 Crore") ||
        text.contains("guarantee cover")) {
      switch (lang) {
        case 'hi':
        case 'mr':
        case 'kok':
    ...
    // PMFME benefit
    if (text.contains("35%") &&
        (text.contains("10 Lakhs") || text.contains("10 Lakh"))) {
      switch (lang) {
        case 'hi':
        case 'mr':
        case 'kok':
    ...
    // PMEGP benefit
    if (text.contains("15% to 35%") ||
        text.contains("50 Lakhs for manufacturing")) {
      switch (lang) {
        case 'hi':
        case 'mr':
        case 'kok':
  ...
  static String _translateSummary(String text, String lang) {
    ...
    if (text.contains("18 traditional trades") ||
        text.contains("Artisans and Craftsmen")) {
      switch (lang) {
        case 'hi':
        case 'mr':
        case 'kok':
    ...
    // NEEDS summary
    if (text.contains("First-generation entrepreneurs") ||
        text.contains("Tamil Nadu")) {
      switch (lang) {
        case 'hi':
        case 'mr':
        case 'kok':
  ...
  static String _translateMinistry(String ministry, String lang) {
    ...
    if (ministry.contains("Micro, Small and Medium Enterprises") ||
        ministry.contains("MSME")) {
      switch (lang) {
        case 'hi':
        case 'mr':
        case 'kok':
  ...
  static String _translateTag(String text, String lang) {
    if (text.contains("Minimum age") || text.contains("minimum_age")) {
      switch (lang) {
        case 'ta':
          return "குறைந்தபட்ச வயது வரம்பு பூர்த்தியானது";
        case 'te':
          return "కనీస వయస్సు నిబంధన పూర్తయింది";
        case 'kn':
          return "ಕನಿಷ್ಠ ವಯಸ್ಸಿನ ಮಾನದಂಡ ಪೂರೈಸಲಾಗಿದೆ";
        case 'ml':
          return "കുറഞ്ഞ പ്രായപരിധി യോഗ്യത നേടി";
        case 'bn':
        case 'as':
          return "নূন্যতম বয়স মাপকাঠি পূরণ হয়েছে";
        case 'gu':
          return "ન્યૂનતમ વય માનદંડ પૂર્ણ";
        case 'ur':
          return "کم از کم عمر کا معیار پورا ہے";
        default:
          return "न्यूनतम आयु मानदंड पूरा हुआ";
      }
    }
    ...
    if (text.contains("Maximum age") || text.contains("maximum_age")) {
      switch (lang) {
        case 'ta':
          return "அதிகபட்ச வயது வரம்பு பொருந்தியது";
        case 'te':
          return "గరిష్ట వయస్సు నిబంధన పూర్తయింది";
        case 'kn':
          return "ಗರಿಷ್ಠ ವಯಸ್ಸಿನ ಮಾನದಂಡ ಪೂರೈಸಲಾಗಿದೆ";
        case 'ml':
          return "പരമാവധി പ്രായപരിധി യോഗ്യത നേടി";
        case 'bn':
        case 'as':
          return "সর্বোচ্চ বয়স মাপকাঠি পূরণ হয়েছে";
        case 'gu':
          return "મહત્તમ વય માનદંડ પૂર્ણ";
        case 'ur':
          return "زیادہ سے زیادہ عمر کا معیار پورا ہے";
        default:
          return "अधिकतम आयु मानदंड पूरा हुआ";
      }
    }

    if (text.contains("operates in your region") ||
        text.contains("All India")) {
      switch (lang) {
        case 'ta':
          return "உங்கள் பிராந்தியத்தில் இத்திட்டம் செயல்படுகிறது (அனைத்து இந்தியா)";
        case 'te':
          return "మీ ప్రాంతంలో ఈ పథకం అందుబాటులో ఉంది (అఖిల భారత)";
        case 'kn':
          return "ನಿಮ್ಮ ಪ್ರದೇಶದಲ್ಲಿ ಈ ಯೋಜನೆ ಲಭ್ಯವಿದೆ (ಸಮಗ್ರ ಭಾರತ)";
        case 'ml':
          return "നിങ്ങളുടെ പ്രദേശത്ത് ഈ പദ്ധതി ലഭ്യമാണ് (ആൾ ഇന്ത്യ)";
        case 'bn':
        case 'as':
          return "আপনার অঞ্চলে এই প্রকল্প চালু আছে (সর্বভারতীয়)";
        case 'gu':
          return "આ યોજના તમારા વિસ્તારમાં કાર્યરત છે (અખિલ ભારતીય)";
        case 'ur':
          return "اسکیم آپ کے علاقے میں فعال ہے (پورے ہندوستان میں)";
        default:
          return "यह योजना आपके क्षेत्र में संचालित है (अखिल भारतीय)";
      }
    }
    ...
    if (text.contains("State eligibility matched")) {
      switch (lang) {
        case 'ta':
          return "மாநில தகுதி பொருந்தியது";
        case 'te':
          return "రాష్ట్ర అర్హత సరిపోలింది";
        case 'kn':
          return "ರಾಜ್ಯ ಅರ್ಹತೆ ಹೊಂದಾಣಿಕೆಯಾಗಿದೆ";
        case 'ml':
          return "സംസ്ഥാന യോഗ്യത പൊരുത്തപ്പെട്ടു";
        case 'bn':
        case 'as':
          return "রাজ্যের যোগ্যতা মিলেছে";
        case 'gu':
          return "રાજ્યની પાત્રતા યોગ્ય છે";
        case 'ur':
          return "ریاستی اہلیت مطابق ہے";
        default:
          return "राज्य की पात्रता मेल खाती है";
      }
    }
