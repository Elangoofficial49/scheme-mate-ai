...
class _DashboardScreenState extends State<DashboardScreen> {
    ...
    if (mounted) {
      ...
      Future.wait([
        schemeProv.fetchRecommendations(
            preferredLanguage: localeProv.languageCode),
  ...
  Widget build(BuildContext context) {
    ...
    final businessDesc =
        _userProfile?["business_description"] ?? context.tr("not_set");
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const PartnerLocatorScreen()),
              );
            },
          ),
          IconButton(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.verified_user,
                                    color: AppTheme.accentSaffron, size: 16),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Wrap(
                                  ...
                                  runSpacing: 8,
                                  children: [
                                    _buildGovAttributeChip(
                                        Icons.cake,
                                        context
                                            .tr("age_chip", {"age": "$age"})),
                                    _buildGovAttributeChip(
                                        Icons.location_on, stateName),
                                    _buildGovAttributeChip(
                                        Icons.groups,
                                        context.tr("category_chip",
                                            {"category": category})),
                                    _buildGovAttributeChip(
                                        Icons.account_balance_wallet,
                                        context.tr("income_chip", {
                                          "income": "$annualIncome",
                                          "source": incomeSource
                                        })),
                                    if (isCertUploaded)
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final List<dynamic> whyMatches =
                              item["why_matches"] as List<dynamic>? ?? [];
                          return Card(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10),
                              side: const BorderSide(
                                  color: AppTheme.borderGrey, width: 1),
                            ),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      // Scheme Name Title
                                      Text(
                                        _localizeText(item["scheme_name"] ?? "",
                                            currentLang),
                                        style: const TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.bold,
